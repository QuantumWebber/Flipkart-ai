      ...
      <main className="flex-1 max-w-7xl w-full mx-auto px-6 py-12">
        ...
        {analysisResult && !isLoading && (
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 animate-fade-in">
            ...
            <div className="lg:col-span-7 flex flex-col gap-8">
              ...
              {analysisResult.nlp_analysis.fake_analysis && (
                <div className="bg-dark-card/50 border border-white/5 rounded-2xl p-6 shadow-xl">
                  ...
                  {analysisResult.nlp_analysis.fake_analysis.flagged_reviews.length > 0 ? (
              ...
              <div className="bg-dark-card/50 border border-white/5 rounded-2xl p-6 shadow-xl">
                ...
                {analysisResult.nlp_analysis.top_themes.length > 0 && (
                  <div className="mt-4">
            ...
            {/* --- AI RECOMMENDATIONS SECTION (Grid list at the bottom) --- */}
